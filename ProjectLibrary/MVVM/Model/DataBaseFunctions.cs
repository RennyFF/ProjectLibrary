...
namespace ProjectLibrary.MVVM.Model
{
    public static class DataBaseFunctions
    {
        ...
        //    }
        //}
        public async static Task<ObservableCollection<GenreCardType>> GetAllGenreCards(NpgsqlConnection Connection, List<GenreHistory> HistoryList)
        {
            try
            {
                ObservableCollection<GenreCardType> Genres = new ObservableCollection<GenreCardType>();
                string query = $"SELECT genre.\"GenreName\",genre.\"ImageAvatar\", genre.\"Id\"  " +
                    $"FROM \"MasterProjectLibrary\".\"Genres\" genre " +
                    $"Where genre.\"Id\" = ";
        ...
        //    }
        //}
        public async static Task<ObservableCollection<AuthorCardType>> GetAllAuthorsCards(NpgsqlConnection Connection, List<AuthorHistory> HistoryList)
        {
            try
            {
                ObservableCollection<AuthorCardType> Authors = new ObservableCollection<AuthorCardType>();
                string query = $"SELECT author.\"SecondName\", author.\"FirstName\", author.\"PatronomycName\",author.\"ImageAvatar\", author.\"Id\" " +
                    $"FROM \"MasterProjectLibrary\".\"Authors\" author " +
                    $"Where author.\"Id\" = ";
                foreach (var item in HistoryList)
        ...
        //    }
        //}
        //public async static Task<ObservableCollection<BookCard>> GetBooksByPage(NpgsqlConnection Connection, int Page, int CountityOnPage, GenreCardType GenreId)
        //{
        //    string query = $"SELECT author.\"SecondName\", author.\"FirstName\",author.\"PatronomycName\", " +
        //        $"book.\"Image\", book.\"Title\", book.\"RatingStars\", book.\"AddedInDatabase\", book.\"Id\", author.\"Id\", genre.\"Id\"" +
        //        $"FROM \"MasterProjectLibrary\".\"Books\" book " +
